...
class CForgotPasswordPage extends StatefulWidget {
  @override
  _CForgotPasswordPageState createState() => _CForgotPasswordPageState();
}

class _CForgotPasswordPageState extends State<CForgotPasswordPage> {
