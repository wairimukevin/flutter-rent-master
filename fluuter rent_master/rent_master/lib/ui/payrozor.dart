...
class payrozor extends StatefulWidget {
  @override
  _payrozorState createState() => _payrozorState();

}

class _payrozorState extends State<payrozor> {
  bool _enabled = true;
                      ...
                      child: Column(
                        children: <Widget>[
                          Align(
                            ...
                            child: Text(
                              'pay to:${docsSnap.data()['firstName']} ${docsSnap.data()['lastName']}',
                              style: TextStyle(
                                fontFamily: 'Ex02',
