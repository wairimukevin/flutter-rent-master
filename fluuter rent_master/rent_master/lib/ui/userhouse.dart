...
import 'package:rent_master/Admin/page_landhouse.dart';
...
class userhouse extends StatefulWidget {
  ...
  @override
  _userhouseState createState() => _userhouseState();
}
...
class _userhouseState extends State<userhouse> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('House').where("firstName",isEqualTo:fname)
                                ...
                                child: InkWell(
                                  onTap: (){
                                    ...
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => LandHouseDetail(docsSnap),
                                      ),
                                    );
                                  },
                                  child: Column(
                                            ...
                                            onPressed: () {
                                              ...
                                              if(_isPressed[index]){
                                                ...
                                                await transaction.update(docsSnap.reference,{
                                                  'favourite': docsSnap.data()['favourite']+1,
                                                });
                                                });
                                                FirebaseFirestore.instance.doc(userRef).update({
