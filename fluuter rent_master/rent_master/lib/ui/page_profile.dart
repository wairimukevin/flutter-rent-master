...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void addSnapshot(){
    FirebaseFirestore.instance.collection("user").doc(docPath).get().then((user){
      print('doc found');
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  image: docSnap.data()['profileImage']!=null ? NetworkImage(docSnap.data()['profileImage']) : AssetImage('assets/icons/avatar.png'),
                                  fit: BoxFit.fill),
                            ),
                          ),
                        ),
                                      ...
                                      children: <Widget>[
                                        Container(
                                          ...
                                          child: Column(
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: <Widget>[
                                              Text(docSnap.data()['firstName']+' '+docSnap.data()['lastName'],style: new TextStyle( fontSize: size.getWidthPx(25))),
                                              docSnap.data()['city']!=null ? Row(children: <Widget>[
                                                Icon(Icons.location_on),
                                                Text(docSnap.data()['city'],style: new TextStyle(fontSize: size.getWidthPx(20)))
                                              ],): SizedBox(width: 0,),
                                            ],
                                          ),
                                        ),
                                                    ...
                                                    Container(
                                                      ...
                                                      child: Center(
                                                        child: IconButton(
                                                          ...
                                                          onPressed: () async {
                                                            var url = "tel:"+docSnap.data()['mobileNo'].toString();
                                        ...
                                        SizedBox(height: size.getWidthPx(10)),
                                        Text(docSnap.data()['firstName']+' '+docSnap.data()['lastName'],style: new TextStyle(fontSize: size.getWidthPx(16))),
                                        ...
                                        SizedBox(height: size.getWidthPx(10),),
                                        Text(docSnap.data()['mobileNo'],style: new TextStyle(fontSize: size.getWidthPx(16))),
                                        Divider(thickness: size.getWidthPx(1),color: Colors.grey,),
                                        SizedBox(height: size.getWidthPx(10),),
                                        Row(children: <Widget>[
                                        ...
                                        SizedBox(height: size.getWidthPx(10),),
                                        Text(docSnap.data()['email'],style: new TextStyle(fontSize: size.getWidthPx(16))),
                                        Divider(thickness: size.getWidthPx(1),color: Colors.grey,),
                                        SizedBox(height: size.getWidthPx(10),),
                                      ],
                                    ),
