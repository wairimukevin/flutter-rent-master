...
class CustomSearchState extends State<CustomSearchPage> {
  ...
  Screen size;
  var citiesList = ["Nairobi", "Mombasa", "Nyeri ", "Karatina","Meru","Malindi","Mwea","Nyahururu"];
  ...
  // Value of Featured City starting from -1 : All city | 0 : Nairobi | 1 : Mombasa | 2 : Nyeri | ... in order mentioned in cityList[] in  line 28
