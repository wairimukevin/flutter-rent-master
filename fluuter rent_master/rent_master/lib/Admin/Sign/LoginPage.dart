...
import 'package:rent_master/Admin/Sign/ForgetPassword.dart';
import 'package:rent_master/Admin/Sign/RegisterPage.dart';
import 'package:rent_master/LocalBindings.dart';
import 'package:rent_master/ui/Landlorddirect.dart';
...
import 'package:rent_master/ui/page_home.dart';
...
class LLoginPage extends StatefulWidget {
  @override
  _LLoginPageState createState() => _LLoginPageState();
}

class _LLoginPageState extends State<LLoginPage> {
    ...
    if (validateAndSave()) {
      try {
        ...
        Navigator.pushReplacement(
            context, MaterialPageRoute(builder: (context) => Landloadredirect()));
      } catch (e) {
        print("error : $e");
        // print('Message');
        // print(e.message);
  ...
  void loginWithGoogle() async{
    try {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => HouseDetail(img)));
    } catch (e) {
              ...
              child: FlatButton(
                onPressed: (){
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => LForgotPasswordPage()));
                },
                child: Text(
                  "FORGOT PASSWORD ?",
                  style: TextStyle(
            ...
            Row(
              ...
              children: <Widget>[
                ...
                FlatButton(
                  ...
                  onPressed: () {
                    Navigator.pushReplacement(context,
                        MaterialPageRoute(builder: (context) => LSignUpPage()));
                  },
                ),
              ],
            )
