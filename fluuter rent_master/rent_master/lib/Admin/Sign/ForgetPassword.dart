...
class LForgotPasswordPage extends StatefulWidget {
  @override
  _LForgotPasswordPageState createState() => _LForgotPasswordPageState();
}

class _LForgotPasswordPageState extends State<LForgotPasswordPage> {
